...
//below middleware will log the request body before body-parser middleware is used
//body data will be undefined here
app.post("/contact-us", (req, res, next) => {
  console.log(`Handling POST request for /contact-us URL: ${req.url} Method: ${req.method} Body:`, req.body );
  next();
})

//here I am starting to use body-parser middleware to parse the incoming request body
app.use(bodyParser.urlencoded());

//below middleware will log the request body after body-parser middleware is used
//body data will be available here
app.post("/contact-us", (req, res, next) => {
  console.log(`Handling POST request for /contact-us URL: ${req.url} Method: ${req.method} Body:`, req.body );
